...
int ApplicationLayerTestMessage::getSender() const
{
    return this->sender;
}

void ApplicationLayerTestMessage::setSender(int sender)
{
    this->sender = sender;
}

bool ApplicationLayerTestMessage::getIsMalicious() const
{
    return this->isMalicious;
}

void ApplicationLayerTestMessage::setIsMalicious(bool isMalicious)
{
...
ApplicationLayerTestMessageDescriptor::ApplicationLayerTestMessageDescriptor() : omnetpp::cClassDescriptor("ib_dtm::ApplicationLayerTestMessage", "veins::BaseFrame1609_4")
{
...
int ApplicationLayerTestMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='i' && strcmp(fieldName, "isMalicious")==0) return base+2;
...
int ApplicationLayerTestMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    ApplicationLayerTestMessage *pp = (ApplicationLayerTestMessage *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

void ApplicationLayerTestMessageDescriptor::setFieldArraySize(void *object, int field, int size) const
{
    throw omnetpp::cRuntimeError("setFieldArraySize() is unsupported in message compiler legacy mode (--msg4 option)");
}

const char *ApplicationLayerTestMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string ApplicationLayerTestMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 2: return bool2string(pp->getIsMalicious());
        default: return "";
    }
}

void ApplicationLayerTestMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount()) {
    ...
    ApplicationLayerTestMessage *pp = (ApplicationLayerTestMessage *)object; (void)pp;
    switch (field) {
        case 0: pp->setSerial(string2long(value)); break;
        case 1: pp->setSender(string2long(value)); break;
        case 2: pp->setIsMalicious(string2bool(value)); break;
...
void *ApplicationLayerTestMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void ApplicationLayerTestMessageDescriptor::setFieldStructValuePointer(void *object, int field, int i, void *ptr) const
{
