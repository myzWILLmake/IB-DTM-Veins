...
#define IB_DTM_VERSION_MAJOR 0
#define IB_DTM_VERSION_MINOR 1
#define IB_DTM_VERSION_PATCH 0
#define IB_DTM_VERSION_ALPHA 0
...
// IB_DTM_API macro. Allows us to use the same .h files for both building a .dll and linking against it
